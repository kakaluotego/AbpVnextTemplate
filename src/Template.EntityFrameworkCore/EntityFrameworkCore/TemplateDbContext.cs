...
namespace Template.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See TemplateMigrationsDbContext for migrations.
     */
    ...
    public class TemplateDbContext : AbpDbContext<TemplateDbContext>
    {
         ...
         * Also map them inside TemplateDbContextModelCreatingExtensions.ConfigureTemplate
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the TemplateEfCoreEntityExtensionMappings class
                 */
            });
